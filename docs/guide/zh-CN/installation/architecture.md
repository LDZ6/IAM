...
![](https://github.com/LDZ6/iam/blob/master/docs/images/%E9%83%A8%E7%BD%B2%E6%9E%B6%E6%9E%84v1.png?raw=true)
...
- **iamctl:** iam 系统的客户端，类似于 `kubectl`，通过 `LDZ6-sdk-go` 访问 `iam-apiserver`
- **LDZ6-sdk-go:**  iam 系统的 golang sdk，类似于 `client-go`
