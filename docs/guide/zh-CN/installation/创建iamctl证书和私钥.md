...
``` bash
$ cd $HOME/LDZ6/work
$ cfssl gencert -ca=$HOME/LDZ6/work/ca.pem \
  -ca-key=$HOME/LDZ6/work/ca-key.pem \
  -config=$HOME/LDZ6/work/ca-config.json \
...
#secret-id: 
#secret-key: 
  client-certificate: /home/admin/LDZ6/work/admin.pem
  client-key: /home/admin/LDZ6/work/admin-key.pem
...
server:
  ...
  certificate-authority: /home/admin/LDZ6/work/ca.pem
