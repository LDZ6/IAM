...
```bash
curl -XDELETE -H'Content-Type: application/json' -H'Authorization: Bearer $Token' http://LDZ6.io:8080/v1/secrets/foo
```
...
}' http://LDZ6.io:8080/v1/secrets/secret
```
**输出示例**
...
```bash
curl -XGET -H'Content-Type: application/json' -H'Authorization: Bearer $Token' -d'' http://LDZ6.io:8080/v1/secrets/secret
```
...
```bash
curl -XPOST -H'Content-Type: application/json' -H'Authorization: Bearer $Token' -d'' http://LDZ6.io:8080/v1/secrets?offset=0&limit=10&fieldSelector=name=secret1
```
