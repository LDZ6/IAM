...
```bash
$ curl -XPOST -H"Authorization: Basic `echo -n 'admin:Admin@2021'|base64`" http://iam.api.LDZ6.com:8080/login
```
...
```bash
$ curl -XPOST http://iam.api.LDZ6.com:8080/logout
```
