...
```bash
curl -XDELETE -H'Content-Type: application/json' -H'Authorization: Bearer $Token' http://LDZ6.io:8080/v1/users?name=foo&name=fooo
```
...
```bash
curl -XDELETE -H'Content-Type: application/json' -H'Authorization: Bearer $Token' http://LDZ6.io:8080/v1/users/foo
```
...
}' http://LDZ6.io:8080/v1/users/foo/change-password
```
...
```bash
curl -XGET -H'Content-Type: application/json' -H'Authorization: Bearer $Token' -d'' http://LDZ6.io:8080/v1/users/foo
```
...
```bash
curl -XPOST -H'Content-Type: application/json' -H'Authorization: Bearer $Token' -d'' http://LDZ6.io:8080/v1/users?offset=0&limit=10&fieldSelector=name=foo
```
