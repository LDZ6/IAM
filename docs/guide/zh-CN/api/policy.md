...
```bash
curl -XDELETE -H'Content-Type: application/json' -H'Authorization: Bearer $Token' http://LDZ6.io:8080/v1/policies?name=policy&name=sdk
```
...
```bash
curl -XDELETE -H'Content-Type: application/json' -H'Authorization: Bearer $Token' http://LDZ6.io:8080/v1/policies/policy
```
...
```bash
curl -XGET -H'Content-Type: application/json' -H'Authorization: Bearer $Token' -d'' http://LDZ6.io:8080/v1/policies/policy
```
...
```bash
curl -XPOST -H'Content-Type: application/json' -H'Authorization: Bearer $Token' -d'' http://LDZ6.io:8080/v1/policies?offset=0&limit=10&fieldSelector=name=policy
```
