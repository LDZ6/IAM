...
访问 https://github.com/LDZ6/iam，点击右上角 **Fork** 按钮。fork 后的仓库地址为：https://github.com/your-user-fork/iam。

2) 克隆 fork 的仓库到本地

```bash
$ git clone https://github.com/your-user-fork/iam
$ cd iam
$ git remote add upstream https://github.com/LDZ6/iam
$ git remote set-url --push upstream no_push # Never push to upstream master
$ git remote -v # Confirm that your remotes make sense
origin	https://github.com/your-user-fork/iam (fetch)
origin	https://github.com/your-user-fork/iam (push)
upstream	https://github.com/LDZ6/iam (fetch)
upstream	https://github.com/LDZ6/iam (push)
```
...
/home/admin/workspace/golang/src/github.com/LDZ6/iam/pkg/db/db.go
...
...
```bash
$ make add-copyright
/home/admin/workspace/golang/src/github.com/LDZ6/iam/pkg/db/db.go added license
```
