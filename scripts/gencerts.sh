...
readonly CERT_HOSTNAME="${CERT_HOSTNAME:-iam.api.LDZ6.com,iam.authz.LDZ6.com},127.0.0.1,localhost"
...
EOF
  ...
  echo '{"CN":"'"${prefix}"'","hosts":[],"key":{"algo":"rsa","size":2048},"names":[{"C":"CN","ST":"BeiJing","L":"BeiJing","O":"LDZ6","OU":"'"${prefix}"'"}]}' \
