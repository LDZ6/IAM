...
```
go get github.com/LDZ6/iam/pkg/shutdown
```

## Documentation

`github.com/LDZ6/iam/pkg/shutdown` documentation is available on [godoc](http://godoc.org/github.com/LDZ6/iam/pkg/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/github.com/LDZ6/iam/pkg/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/github.com/LDZ6/iam/pkg/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"github.com/LDZ6/iam/pkg/shutdown"
	"github.com/LDZ6/iam/pkg/shutdown/shutdownmanagers/awsmanager"
	"github.com/LDZ6/iam/pkg/shutdown/shutdownmanagers/posixsignal"
)
