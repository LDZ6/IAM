...
import (
	...
	cliflag "github.com/LDZ6/component-base/pkg/cli/flag"
	"github.com/spf13/cobra"
	"github.com/spf13/viper"

	"github.com/LDZ6/iam/internal/iamctl/cmd/color"
	"github.com/LDZ6/iam/internal/iamctl/cmd/completion"
	"github.com/LDZ6/iam/internal/iamctl/cmd/info"
	"github.com/LDZ6/iam/internal/iamctl/cmd/jwt"
	"github.com/LDZ6/iam/internal/iamctl/cmd/new"
	"github.com/LDZ6/iam/internal/iamctl/cmd/options"
	"github.com/LDZ6/iam/internal/iamctl/cmd/policy"
	"github.com/LDZ6/iam/internal/iamctl/cmd/secret"
	"github.com/LDZ6/iam/internal/iamctl/cmd/set"
	"github.com/LDZ6/iam/internal/iamctl/cmd/user"
	cmdutil "github.com/LDZ6/iam/internal/iamctl/cmd/util"
	"github.com/LDZ6/iam/internal/iamctl/cmd/validate"
	"github.com/LDZ6/iam/internal/iamctl/cmd/version"
	"github.com/LDZ6/iam/internal/iamctl/util/templates"
...
func NewIAMCtlCommand(in io.Reader, out, err io.Writer) *cobra.Command {
	...
	cmds := &cobra.Command{
		...
		Find more information at:
			https://github.com/LDZ6/iam/blob/master/docs/guide/en-US/cmd/iamctl/iamctl.md`),
		Run: runHelp,
