...
//go:generate mockgen -destination mock_authorization.go -package authorization github.com/LDZ6/iam/internal/authzserver/authorization AuthorizationInterface
