...
import (
	...
	"github.com/LDZ6/iam/internal/apiserver/controller/v1/policy"
	"github.com/LDZ6/iam/internal/apiserver/controller/v1/secret"
	"github.com/LDZ6/iam/internal/apiserver/controller/v1/user"
	...
	"github.com/LDZ6/iam/internal/pkg/middleware/auth"

	// custom gin validators.
	_ "github.com/LDZ6/iam/pkg/validator"
)
